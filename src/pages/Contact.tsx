            ...
            <div className="bg-gray-50 p-8 rounded-lg shadow-sm">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-900 font-medium">contact@webgrowthpro.com</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">
                    123 Digital Avenue, Suite 101<br />
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="text-gray-600 hover:text-purple-700 transition-colors duration-300">
